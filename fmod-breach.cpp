#define SOUND_DIR "/path/to/Transistor/Content/Audio/AudenFMOD/Build/Desktop/"
...
int main(int argc, char ** argv)
{
    ...
    ERRCHECK(lowLevelSystem->setPluginPath("/path/to/plugins/folder")); // Mind no slash at the end
    ERRCHECK(lowLevelSystem->loadPlugin("libFModPlugins.so", &handle, 0)); // Name of your lib filename
